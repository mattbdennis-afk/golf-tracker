...
const icon  = {pos:”^”,neg:“v”,neu:”->”,focus:”*”};
...
{[[“v Short”,round.greenShort,C.neg],[”^ Long”,round.greenLong,”#6a2abf”],[”< Left”,round.greenLeft,”#8b4500”],[”> Right”,round.greenRight,C.blue]].map(([l,v,c])=>(
...
const arr=(v,p,lb)=>{if(!p)return null;const ok=lb?v<p:v>p;return <span style={{color:ok?C.pos:C.neg,fontSize:8,marginLeft:2}}>{ok?”^”:“v”}</span>;};
...
{[[“v Short”,SA.greenShort,C.neg],[”^ Long”,SA.greenLong,”#6a2abf”],[”< Left”,SA.greenLeft,”#8b4500”],[”> Right”,SA.greenRight,C.blue]].map(([l,v,c])=>(
<div key={l} style={{marginBottom:10}}>
<div style={{display:“flex”,justifyContent:“space-between”,marginBottom:3}}>
<span style={{fontSize:11,color:C.inkSoft}}>{l}</span>
